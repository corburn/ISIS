 ...
 * $Id: SpiceSegment.cpp 5086 2013-03-15 18:35:41Z elee $
 *
...
SpiceSegment::SpiceSegment(Cube &cube) {
  init(cube);
}
...
/** Sets start time  */
void SpiceSegment::setStartTime(double et) {
  _startTime = et;
  _utcStartTime = toUTC(_startTime);
}

/** Sets end time */
void SpiceSegment::setEndTime(double et) {
  _endTime = et;

 ...
 * $Id: ZeroBufferSmooth.h 4943 2013-01-04 18:02:32Z janderson $
 * 
  ...
  class ZeroBufferSmooth : public Module {
    ...
    private:
      ...
      void init(HiCalData &cal, const HiCalConf &conf) {
        ...
        int samp0 = toInt(ConfKey(prof, "ZeroBufferSmoothFirstSample", toString(0)));
        int sampN = toInt(ConfKey(prof, "ZeroBufferSmoothLastSample", toString(11)));
        ...
        LowPassFilter bufter(_buffer, _history,
                          toInt(ConfKey(prof, "ZeroBufferSmoothFilterWidth", toString(201))),
                          toInt(ConfKey(prof, "ZeroBufferSmoothFilterIterations", toString(2))));
